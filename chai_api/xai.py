...
from chai_api.responses import XAIRegion, XAIBand


class XAIProfileResource:
    def get_profile(self, req: Request, resp: Response, parameters: XAIGet) -> (bool, Optional[Profile]):  # noqa
        try:
            ...
            profile: Profile = query.offset(parameters.skip).first()
